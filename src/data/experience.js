...
export const education = [
  {
    id: 1,
    degree: 'MSc Computer Games Programming',
    institution: 'Goldsmiths, University of London',
    period: '2019 — 2020',
    description:
      'Specialised in real-time rendering, game engine architecture, and interactive systems development.',
  },
  {
    id: 2,
    ...
    period: '2015 — 2017',
    description:
      'Intelligent Systems and Software Engineering. Thesis in Deep Learning. GPA: 16.38/20.',
  },
  {
    id: 3,
    ...
    period: '2012 — 2015',
    description:
      'Core foundations in algorithms, data structures, software engineering, and distributed systems. GPA: 16.84/20.',
  },
];
